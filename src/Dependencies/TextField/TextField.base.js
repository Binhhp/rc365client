...
var TextFieldBase = /** @class */ (function (_super) {
  ...
  function TextFieldBase(props) {
    ...
    _this._delayedValidate = _this._async.debounce(
      _this._validate,
  ...
  TextFieldBase.prototype.getSnapshotBeforeUpdate = function (
    prevProps,
    prevState
  ) {
    return {
  ...
  TextFieldBase.prototype.render = function () {
    ...
    let condition =
      !this._isDescriptionAvailable && darkMode === "dark"
        ? "#ffffff !important"
        : !this._isDescriptionAvailable && darkMode !== "dark"
        ? "#a6a6a6 !important"
        : "transparent";
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          "div",
          {
            ...
            "data-rc-id": rcName ? `blk.txt.${rcName}` : undefined,
          },
      ...
      React.createElement(
        "span",
        {
          ...
          style: {
            display: `${this._isDescriptionAvailable ? "block" : "none"}`,
          },
        },
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              "p",
              {
                "data-rc-id": rcName ? `sp.err.${rcName}` : undefined,
  ...
  TextFieldBase.prototype._renderTextArea = function () {
    ...
    return React.createElement(
      "textarea",
      __assign({ id: this._id }, textAreaProps, {
        ...
        "aria-describedby": this._isDescriptionAvailable
          ? this._descriptionId
        ...
        onBlur: this._onBlur,
        "data-rc-id": rcName ? `txa.${rcName}` : undefined,
      })
    );
  };
  TextFieldBase.prototype._renderInput = function () {
    ...
    return React.createElement(
      "input",
      __assign(
        { type: "text", id: this._id, "aria-labelledby": ariaLabelledBy },
        inputProps,
        {
          ref: this._textElement,
          value: this.value || "",
  ...
  TextFieldBase.prototype._notifyAfterValidate = function (
    value,
    errorMessage
  ) {
