...
import { IsFocusVisibleClassName, RectangleEdge } from "../@uifabric/utilities";
import {
  FontWeights,
...
var highContrastAdjustMixin =
  ...
  (_a[
    HighContrastSelector +
      ", " +
      HighContrastSelectorWhite.replace("@media ", "")
  ] = {
  ...
  return {
        ...
        selectors:
          ...
          (_b["&:focus ." + globalClassnames.title] = [
            !disabled && rootHoverFocusActiveSelectorNeutralDarkMixin,
            {
              selectors:
                ((_c = {}),
                (_c[HighContrastSelector] = { color: "Highlight" }),
                _c),
            },
          ]),
          (_b["&:focus:after"] = [
          ...
          (_b["&:hover ." + globalClassnames.caretDown] =
          ...
          (_b["&:focus ." + globalClassnames.caretDown] = [
            !disabled && rootHoverFocusActiveSelectorNeutralPrimaryMixin,
            {
              selectors:
                ((_e = {}),
                (_e[HighContrastSelector] = { color: "Highlight" }),
                _e),
            },
          ]),
          (_b["&:active ." + globalClassnames.caretDown] =
            !disabled && rootHoverFocusActiveSelectorNeutralPrimaryMixin),
          (_b["&:hover ." + globalClassnames.titleIsPlaceHolder] =
            !disabled && rootHoverFocusActiveSelectorNeutralPrimaryMixin),
          (_b["&:focus ." + globalClassnames.titleIsPlaceHolder] =
            !disabled && rootHoverFocusActiveSelectorNeutralPrimaryMixin),
          (_b["&:active ." + globalClassnames.titleIsPlaceHolder] =
            !disabled && rootHoverFocusActiveSelectorNeutralPrimaryMixin),
          (_b["&:hover ." + globalClassnames.titleHasError] = borderColorError),
          (_b["&:active ." + globalClassnames.titleHasError] =
            borderColorError),
          _b),
      },
      isOpen && "is-open",
    ...
    caretDown: [
      ...
      disabled && {
        color: semanticColors.disabledText,
        selectors:
          ((_h = {}), (_h[HighContrastSelector] = { color: "GrayText" }), _h),
      },
    ],
    errorMessage: __assign(
      __assign({ color: semanticColors.errorText }, theme.fonts.small),
      { paddingTop: 5 }
    ),
    callout: [
    ...
    dropdownDivider: [
      ...
      { height: 1, backgroundColor: semanticColors.bodyDivider },
    ],
    dropdownOptionText: [
    ...
    dropdownItemHeader: [
      ...
      __assign(__assign({}, fonts.medium), {
