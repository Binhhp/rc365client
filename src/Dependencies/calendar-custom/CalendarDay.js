...
import { TypePick } from "./CalenderStyle";
...
var CalendarDay = /** @class */ (function (_super) {
  ...
  CalendarDay.prototype.render = function () {
    ...
    var nextMonthInBounds = maxDate
      ...
      : true;
    let monthCal = navigatedDate.getMonth() + 1;
    let yearCal = navigatedDate.getFullYear();
          ...
          this.props.onHeaderSelect
            ? React.createElement(
                "div",
                {
                  ...
                  role: "button",
                  "data-rc-id": rcName ? `btn.month.${rcName}.${monthCal}/${yearCal}` : undefined,
                  tabIndex: 0,
                },
          ...
          React.createElement(
            ...
            React.createElement(
              "button",
              {
                ...
                role: "button",
                type: "button",
                "data-rc-id": rcName ? `btn.prev.${rcName}` : undefined,
              },
            ...
            React.createElement(
              "button",
              {
                ...
                role: "button",
                type: "button",
                "data-rc-id": rcName ? `btn.next.${rcName}` : undefined,
              },
              React.createElement(Icon, {
            ...
            showCloseButton &&
              React.createElement(
                "button",
                {
                  ...
                  role: "button",
                  type: "button",
                  "data-rc-id": rcName ? `btn.close.${rcName}` : undefined,
                },
                React.createElement(Icon, {
            ...
            weeks.map(function (week, weekIndex) {
              ...
              return React.createElement(
                ...
                week.map(function (day, dayIndex) {
                  ...
                  let arrClass = HighLightDays[0].split(" ");
                  let isSelected = arrClass.some(
                    (text) => text === "multiple-highlight"
                  );
                  var _a, _b;
                  ...
                  return React.createElement(
                    "td",
                    {
                      ...
                      onMouseLeave:
                        dateRangeType !== DateRangeType.Day && day.isInBounds
                          ...
                          : undefined,
                      onMouseDown: () => {
                        let { calendarData } = _this.props;

                        if (calendarData.pickType !== TypePick.single) {
                          _this.setState({
                            startDate: day.originalDate,
                      ...
                      role: "gridcell",
                      onMouseMove: () => {
                        if (_this.state.isDragSelection) {
                          _this.props.onGetSelectionDate &&
                            _this.props.onGetSelectionDate(
                    ...
                    React.createElement(
                      "button",
                      {
                        ...
                        type: "button",
                        "data-rc-id":`btn.cal.${rcName}.day.${day.originalDate.toLocaleDateString()}`,
                      },
                      React.createElement(
                        "span",
                        {
