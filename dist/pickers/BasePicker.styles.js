...
function getStyles(props) {
  ...
  var classNames = (0, _styling.getGlobalClassNames)(GlobalClassNames, theme); // The following lines are to create a semi-transparent color overlay for the disabled state with designer's approval.
  ...
  return {
    ...
    }, isFocused && !disabled && (0, _styling.getInputFocusStyle)(inputFocusBorderAlt, effects.roundedCorner2), disabled && {
