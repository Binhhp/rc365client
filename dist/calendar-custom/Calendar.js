...
import { DayOfWeek, FirstWeekOfYear, DateRangeType } from "./CalenderStyle";
import { CalendarDay } from "./CalendarDay";
import { CalendarMonth } from "./CalendarMonth";
import { compareDates, getDateRangeArray } from "../dateMath/dateMath";
import {
  css,
  KeyCodes,
  getNativeProps,
  ...
  Calendar.prototype.render = function () {
    ...
    return React.createElement(
      "div",
      {
        ...
        role: "application",
        "data-rc-id": rcName ? `cal.main.${rcName}` : undefined,
      },
      React.createElement(
        "div",
            ...
            React.createElement(
              ...
              isDayPickerVisible &&
                React.createElement(CalendarDay, {
                  ...
                  onGetSelectionDate: this.props.onGetSelectionDate,
              ...
              showGoToToday &&
                React.createElement(
                  "button",
                  {
                    ...
                    type: "button",
                    "data-rc-id": rcName ? `btn.toDay.${rcName}` : undefined,
                  },
                  strings.goToToday
                )
            )
