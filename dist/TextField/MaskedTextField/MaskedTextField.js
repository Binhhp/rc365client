...
import { initializeComponentRef, KeyCodes } from "../../@uifabric/utilities";
import {
  clearNext,
  clearPrev,
  clearRange,
...
var MaskedTextField = /** @class */ (function (_super) {
  ...
  function MaskedTextField(props) {
    ...
    _this._onMouseUp = function (event) {
      ...
      if (
        _this._moveCursorOnMouseUp &&
        !_this.props.isDisableFocusToLeftUnfilled
      ) {
    ...
    _this._onInputChange = function (ev, value) {
      ...
      if (_this._changeSelectionData === null && textField) {
        _this._changeSelectionData = {
          changeType: "default",
          selectionStart:
            textField.selectionStart !== null ? textField.selectionStart : -1,
          selectionEnd:
            textField.selectionEnd !== null ? textField.selectionEnd : -1,
        };
      }
      ...
      if (changeType === "textPasted") {
        ...
        if (charsSelected) {
          _this._maskCharData = clearRange(
            _this._maskCharData,
            selectionStart,
            charsSelected
          );
        ...
        if (charCount) {
          ...
          if (isDel) {
            _this._maskCharData = clearNext(
              _this._maskCharData,
              selectionStart
            );
            cursorPos = getRightFormatIndex(
              _this._maskCharData,
              selectionStart
            );
          } else {
            _this._maskCharData = clearPrev(
              _this._maskCharData,
              selectionStart
            );
      ...
      var newValue = getMaskDisplay(
        _this.props.mask,
        _this._maskCharData,
        _this.props.maskChar
      );
      _this.setState({
  ...
  MaskedTextField.prototype.UNSAFE_componentWillReceiveProps = function (
    newProps
  ) {
    if (
      newProps.mask !== this.props.mask ||
  ...
  MaskedTextField.prototype.componentDidUpdate = function () {
    ...
    if (
      this._isFocused &&
      this.state.maskCursorPosition !== undefined &&
      this._textField.current
    ) {
      this._textField.current.setSelectionRange(
  ...
  Object.defineProperty(MaskedTextField.prototype, "selectionStart", {
    get: function () {
      var current = this._textField.current;
      return current && current.selectionStart !== null
