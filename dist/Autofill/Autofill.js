...
exports.BaseAutoFill = exports.Autofill = void 0;
...
/** @class */
function (_super) {
  (0, _tslib.__extends)(Autofill, _super);

  function Autofill(props) {
    var _this = _super.call(this, props) || this;

    _this._inputElement = /*#__PURE__*/React.createRef();
    ...
    _this._onKeyDown = function (ev) {
      ...
      if (!ev.nativeEvent.isComposing) {
        switch (ev.which) {
          ...
          case _utilities.KeyCodes.left:
          case _utilities.KeyCodes.right:
  ...
  Autofill.prototype.render = function () {
    ...
    var nativeProps = (0, _utilities.getNativeProps)(this.props, _utilities.inputProperties);
    ...
    }, type === "users" && /*#__PURE__*/React.createElement(_Icon.Icon, {
      iconName: "Search",
      styles: {
        root: {
    ...
    }, null), /*#__PURE__*/React.createElement("input", (0, _tslib.__assign)({
      autoCapitalize: "off",
      autoComplete: "off",
      "aria-autocomplete": "both",
      "data-rc-id": rcName ? "txt.".concat(rcName) : undefined
    }, nativeProps, {
    ...
    })), isLoading && /*#__PURE__*/React.createElement(_Spinner.Spinner, {
      size: _Spinner.SpinnerSize.small,
      style: {
        padding: "0 10px"
      }
    }));
  ...
  Autofill.defaultProps = {
    enableAutofillOnKeyPress: [_utilities.KeyCodes.down, _utilities.KeyCodes.up]
  };
  return Autofill;
}(React.Component);
...
/** @class */
function (_super) {
  (0, _tslib.__extends)(BaseAutoFill, _super);
