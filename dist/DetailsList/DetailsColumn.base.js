...
var DetailsColumnBase =
  /** @class */
  (function (_super) {
    (0, _tslib.__extends)(DetailsColumnBase, _super);
        ...
        if (itemIndex) {
          ...
          _this._async.setTimeout(function () {
            if (_this._root.current) {
              _this._root.current.classList.add(
                classNames.noBorderWhileDragging
              );
            }
    ...
    DetailsColumnBase.prototype.render = function () {
      var _a = this.props,
        ...
        cellStyleProps =
          _b === void 0 ? _DetailsRow.DEFAULT_CELL_STYLE_PROPS : _b,
        _c = _a.useFastIcons,
      ...
      return /*#__PURE__*/ React.createElement(
        ...
        /*#__PURE__*/ React.createElement(
          "div",
          {
            ...
            "data-rc-id": rcName
              ? "col.".concat(column.key, ".").concat(rcName)
              : undefined,
          },
          isDraggable &&
          ...
          onRenderColumnHeaderTooltip(
            {
              ...
              content:
                ...
                _DetailsList.ColumnActionsMode.disabled
                  ? column.ariaLabel
                  : "",
              children: /*#__PURE__*/ React.createElement(
                "span",
                {
                  ...
                  "aria-haspopup":
                    column.columnActionsMode ===
                    _DetailsList.ColumnActionsMode.hasDropdown,
                  "aria-expanded":
                    column.columnActionsMode ===
                    _DetailsList.ColumnActionsMode.hasDropdown
                      ? !!column.isMenuOpen
                ...
                /*#__PURE__*/ React.createElement(
                  ...
                  (column.iconName || column.iconClassName) &&
                    /*#__PURE__*/ React.createElement(IconComponent, {
                      ...
                      "data-rc-id": "ico.".concat(column.iconName),
                    }),
                  column.isIconOnly
                    ? /*#__PURE__*/ React.createElement(
                        "span",
                  ...
                  /*#__PURE__*/ React.createElement(IconComponent, {
                    ...
                    "data-rc-id": rcName
                      ? "ico."
                          .concat(rcName, ".")
                          .concat(column.key, ".")
                          .concat(!column.isSortedDescending ? "Asc" : "Desc")
                      : undefined,
        ...
        column.isFilter &&
          ...
          /*#__PURE__*/ React.createElement(
            "div",
            {
              ...
              "data-rc-id": rcName
                ? "btn.clear.".concat(rcName, ".").concat(column.key)
                : undefined,
            },
            /*#__PURE__*/ React.createElement(IconComponent, {
              className: classNames.sortIcon,
        ...
        this._async.setTimeout(function () {
          if (_this._root.current) {
            _this._root.current.classList.remove(
              classNames.borderAfterDropping
            );
