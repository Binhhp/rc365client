...
exports.DetailsListAdvancedExample = void 0;
...
var classNames = (0, _Styling.mergeStyleSets)({
  ...
  root: {
    selectors: (_a = {}, _a["." + headerDividerClass + ":hover + ." + headerDividerClass] = {
      display: 'inline'
    }, _a)
  }
});
...
var DetailsListAdvancedExample =
/** @class */
function (_super) {
  (0, _tslib.__extends)(DetailsListAdvancedExample, _super);
  ...
  function DetailsListAdvancedExample(props) {
    ...
    _this._onRenderDivider = function (columnProps, defaultRenderer) {
      ...
      return /*#__PURE__*/React.createElement(React.Fragment, {
        key: "divider-wrapper-" + columnIndex
      }, /*#__PURE__*/React.createElement("span", {
        className: classNames.headerDivider
      }, defaultRenderer(columnProps)), /*#__PURE__*/React.createElement("span", {
    ...
    _this._onToggleResizing = function () {
      var _a = _this.state,
          items = _a.items,
          sortedColumnKey = _a.sortedColumnKey,
          ...
          items: [{
            ...
            subMenuProps: {
              items: [{
                ...
                text: 'Always',
                canCheck: true,
                isChecked: checkboxVisibility === _DetailsList.CheckboxVisibility.always,
                onClick: _this._onCheckboxVisibilityChanged,
                data: _DetailsList.CheckboxVisibility.always
              }, {
                key: 'checkboxVisibility.onHover',
                text: 'On hover',
                canCheck: true,
                isChecked: checkboxVisibility === _DetailsList.CheckboxVisibility.onHover,
                onClick: _this._onCheckboxVisibilityChanged,
                data: _DetailsList.CheckboxVisibility.onHover
              }, {
                key: 'checkboxVisibility.hidden',
                text: 'Hidden',
                canCheck: true,
                isChecked: checkboxVisibility === _DetailsList.CheckboxVisibility.hidden,
                onClick: _this._onCheckboxVisibilityChanged,
                data: _DetailsList.CheckboxVisibility.hidden
              }]
            }
          }, {
            key: 'layoutMode',
            ...
            subMenuProps: {
              items: [{
                key: _DetailsList.DetailsListLayoutMode[_DetailsList.DetailsListLayoutMode.fixedColumns],
                text: 'Fixed columns',
                canCheck: true,
                checked: layoutMode === _DetailsList.DetailsListLayoutMode.fixedColumns,
                onClick: _this._onLayoutChanged,
                data: _DetailsList.DetailsListLayoutMode.fixedColumns
              }, {
                key: _DetailsList.DetailsListLayoutMode[_DetailsList.DetailsListLayoutMode.justified],
                text: 'Justified columns',
                canCheck: true,
                checked: layoutMode === _DetailsList.DetailsListLayoutMode.justified,
                onClick: _this._onLayoutChanged,
                data: _DetailsList.DetailsListLayoutMode.justified
              }]
            }
          }, {
            key: 'selectionMode',
            ...
            subMenuProps: {
              items: [{
                key: _DetailsList.SelectionMode[_DetailsList.SelectionMode.none],
                text: 'None',
                canCheck: true,
                checked: selectionMode === _DetailsList.SelectionMode.none,
                onClick: _this._onSelectionChanged,
                data: _DetailsList.SelectionMode.none
              }, {
                key: _DetailsList.SelectionMode[_DetailsList.SelectionMode.single],
                text: 'Single select',
                canCheck: true,
                checked: selectionMode === _DetailsList.SelectionMode.single,
                onClick: _this._onSelectionChanged,
                data: _DetailsList.SelectionMode.single
              }, {
                key: _DetailsList.SelectionMode[_DetailsList.SelectionMode.multiple],
                text: 'Multi select',
                canCheck: true,
                checked: selectionMode === _DetailsList.SelectionMode.multiple,
                onClick: _this._onSelectionChanged,
                data: _DetailsList.SelectionMode.multiple
              }]
            }
          }, {
            key: 'constrainMode',
            ...
            subMenuProps: {
              items: [{
                key: _DetailsList.ConstrainMode[_DetailsList.ConstrainMode.unconstrained],
                text: 'Unconstrained',
                canCheck: true,
                checked: constrainMode === _DetailsList.ConstrainMode.unconstrained,
                onClick: _this._onConstrainModeChanged,
                data: _DetailsList.ConstrainMode.unconstrained
              }, {
                key: _DetailsList.ConstrainMode[_DetailsList.ConstrainMode.horizontalConstrained],
                text: 'Horizontal constrained',
                canCheck: true,
                checked: constrainMode === _DetailsList.ConstrainMode.horizontalConstrained,
                onClick: _this._onConstrainModeChanged,
                data: _DetailsList.ConstrainMode.horizontalConstrained
              }]
            }
          }]
        }
    ...
    _this._onColumnClick = function (ev, column) {
      if (column.columnActionsMode !== _DetailsList.ColumnActionsMode.disabled) {
        _this.setState({
    ...
    _this._onGroupByColumn = function (column) {
      ...
      if (isGrouped) {
        ...
        if (groups) {
          newGroups = (0, _tslib.__spreadArrays)(groups);
        ...
        _this.setState({
          items: groupedItems,
          columns: (0, _tslib.__spreadArrays)(columns),
          groups: newGroups
        });
      }
    };
    ...
    _this._onAddRow = function () {
      _this.setState({
        items: (0, _exampleData.createListItems)(1).concat(_this.state.items)
      });
    };
    ...
    _this._onDeleteRow = function () {
      if (_this._selection.getSelectedCount() > 0) {
        _this.setState(function (previousState) {
          return {
            items: previousState.items.filter(function (item, index) {
              return !_this._selection.isIndexSelected(index);
            })
          };
        });
      } else {
    ...
    _this._getCommandItems = (0, _Utilities.memoizeFunction)(_this._getCommandItems);
    _this._allItems = (0, _exampleData.createListItems)(ITEMS_COUNT);
    ...
    _this.state = {
      ...
      constrainMode: _DetailsList.ConstrainMode.horizontalConstrained,
      selectionMode: _DetailsList.SelectionMode.multiple,
      canResizeColumns: true,
      checkboxVisibility: _DetailsList.CheckboxVisibility.onHover,
  ...
  DetailsListAdvancedExample.prototype.render = function () {
    ...
    var groupProps = {
      getGroupItemLimit: function getGroupItemLimit(group) {
        if (group) {
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, /*#__PURE__*/React.createElement(_CommandBar.CommandBar, {
      ...
      farItems: [{
        key: 'count',
        text: this.state.selectionCount + " selected"
      }]
    }), /*#__PURE__*/React.createElement(_Announced.Announced, {
      message: this.state.selectionCount + " selected"
    }), isGrouped ? /*#__PURE__*/React.createElement(_TextField.TextField, {
      label: "Group item limit",
      onChange: this._onItemLimitChanged
    }) : null, announcedMessage ? /*#__PURE__*/React.createElement(_Announced.Announced, {
      message: announcedMessage
    }) : undefined, /*#__PURE__*/React.createElement(_DetailsList.DetailsList, {
      setKey: "items",
      items: items,
    ...
    }), contextualMenuProps && /*#__PURE__*/React.createElement(_ContextualMenu.ContextualMenu, (0, _tslib.__assign)({}, contextualMenuProps)));
  };
  ...
  DetailsListAdvancedExample.prototype._onDataMiss = function (index) {
    ...
    if (!this._isFetchingItems) {
      ...
      setTimeout(function () {
        ...
        var itemsCopy = (0, _tslib.__spreadArrays)(_this.state.items);
  ...
  DetailsListAdvancedExample.prototype._getContextualMenuProps = function (ev, column) {
    ...
    var items = [{
      ...
      onClick: function onClick() {
        return _this._onSortColumn(column.key, false);
      }
    }, {
      key: 'zToA',
      name: 'Z to A',
      ...
      checked: column.isSorted && column.isSortedDescending,
      onClick: function onClick() {
        return _this._onSortColumn(column.key, true);
      }
    }];

    if ((0, _exampleData.isGroupable)(column.key)) {
      items.push({
        key: 'groupBy',
        ...
        onClick: function onClick() {
          return _this._onGroupByColumn(column);
        }
      });
    }
  ...
  DetailsListAdvancedExample.prototype._buildColumns = function (items, canResizeColumns, onColumnClick, sortedColumnKey, isSortedDescending, groupedColumnKey, onColumnContextMenu) {
    ...
    var columns = (0, _DetailsList.buildColumns)(items, canResizeColumns, onColumnClick, sortedColumnKey, isSortedDescending, groupedColumnKey);
    columns.forEach(function (column) {
      ...
      if (column.key === 'thumbnail') {
        ...
        column.onRender = function (item) {
          return /*#__PURE__*/React.createElement(_Link.Link, {
            "data-selection-invoke": true
          }, item.name);
        };
      } else if (column.key === 'key') {
        column.columnActionsMode = _DetailsList.ColumnActionsMode.disabled;
