...
var highContrastAdjustMixin = (_a = {}, _a[_styling.HighContrastSelector + ", " + _styling.HighContrastSelectorWhite.replace("@media ", "")] = {
  MsHighContrastAdjust: "none"
}, _a);
var highContrastItemAndTitleStateMixin = {
  selectors: (0, _tslib.__assign)((_b = {}, _b[_styling.HighContrastSelector] = {
...
var MinimumScreenSelector = (0, _styling.getScreenSelector)(0, _styling.ScreenWidthMinMedium);
...
var getStyles = function getStyles(props) {
  ...
  var itemSelectors = function itemSelectors(isSelected) {
    ...
    return {
      selectors: (_a = {
        ...
        borderColor: "Window"
      }, _a["." + _utilities.IsFocusVisibleClassName + " &:focus:after"] = {
        left: 0,
        top: 0,
        bottom: 0,
        right: 0
  ...
  var titleOpenBorderRadius = calloutRenderEdge === _utilities.RectangleEdge.bottom ? effects.roundedCorner2 + " " + effects.roundedCorner2 + " 0 0" : "0 0 " + effects.roundedCorner2 + " " + effects.roundedCorner2;
  var calloutOpenBorderRadius = calloutRenderEdge === _utilities.RectangleEdge.bottom ? "0 0 " + effects.roundedCorner2 + " " + effects.roundedCorner2 : effects.roundedCorner2 + " " + effects.roundedCorner2 + " 0 0";
  return {
    root: [globalClassnames.root, className],
    label: globalClassnames.label,
    dropdown: [globalClassnames.dropdown, _styling.normalize, fonts.medium, {
      color: semanticColors.menuItemText,
      ...
      }, _f[_styling.HighContrastSelector] = {
        selectors: {
          ":after": {
            right: -14
          }
    ...
    title: [globalClassnames.title, _styling.normalize, {
    ...
    dropdownItem: (0, _tslib.__spreadArrays)(dropdownItemStyle, [itemSelectors()]),
    ...
    dropdownItemHeader: [globalClassnames.dropdownItemHeader, (0, _tslib.__assign)((0, _tslib.__assign)({}, fonts.medium), {
