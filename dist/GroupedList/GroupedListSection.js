...
/** @class */
function (_super) {
  (0, _tslib.__extends)(GroupedListSection, _super);
  ...
  function GroupedListSection(props) {
    ...
    _this._onRenderGroupHeader = function (props) {
      ...
      return /*#__PURE__*/React.createElement(_GroupHeader.GroupHeader, (0, _tslib.__assign)({
        rcName
      }, props));
    };

    _this._onRenderGroupShowAll = function (props) {
      return /*#__PURE__*/React.createElement(_GroupShowAll.GroupShowAll, (0, _tslib.__assign)({}, props));
    };

    _this._onRenderGroupFooter = function (props) {
      return /*#__PURE__*/React.createElement(_GroupFooter.GroupFooter, (0, _tslib.__assign)({}, props));
    };
    ...
    _this._renderSubGroup = function (subGroup, subGroupIndex) {
      ...
      return !subGroup || subGroup.count > 0 || groupProps && groupProps.showEmptyGroups ? /*#__PURE__*/React.createElement(GroupedListSection, {
    ...
    _this._id = (0, _utilities.getId)("GroupedListSection");
    _this.state = {
      isDropping: false,
  ...
  GroupedListSection.prototype.render = function () {
    ...
    var groupHeaderProps = (0, _tslib.__assign)((0, _tslib.__assign)((0, _tslib.__assign)({}, headerProps), dividerProps), ariaControlsProps);
    var groupShowAllProps = (0, _tslib.__assign)((0, _tslib.__assign)({}, showAllProps), dividerProps);
    var groupFooterProps = (0, _tslib.__assign)((0, _tslib.__assign)({}, footerProps), dividerProps);
    var isDraggable = !!this.props.dragDropHelper && this._getGroupDragDropOptions().canDrag(group) && !!this.props.dragDropEvents.canDragGroups; // groupHeaderProps

    if (onGetSelectedGroups) {
      onGetSelectedGroups(group);
    }

    return /*#__PURE__*/React.createElement("div", (0, _tslib.__assign)({
      ref: this._root
    }, isDraggable && {
      draggable: true
    }, {
      className: (0, _utilities.css)(groupedListClassNames && groupedListClassNames.group, this._getDroppingClassName()),
      role: "presentation"
    }), onRenderGroupHeader(groupHeaderProps, this._onRenderGroupHeader), group && group.key === "lastGroup" && /*#__PURE__*/React.createElement(_List.List, {
      role: "presentation",
      ref: this._list,
      ...
      rcName,
      id: this._id
    }), group && group.isCollapsed ? null : hasNestedGroups ? /*#__PURE__*/React.createElement(_List.List, {
      role: "presentation",
      ref: this._list,
      items: group ? group.children : [],
      onRenderCell: this._renderSubGroup,
  ...
  GroupedListSection.prototype._onRenderGroup = function (renderCount) {
    ...
    return /*#__PURE__*/React.createElement(_List.List, (0, _tslib.__assign)({
  ...
  GroupedListSection.prototype._getDroppingClassName = function () {
    ...
    return (0, _utilities.css)(isDropping && this._droppingClassName, isDropping && DEFAULT_DROPPING_CSS_CLASS, isDropping && groupedListClassNames && groupedListClassNames.groupIsDropping);
  };
