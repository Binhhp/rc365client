...
var getClassNames = (0, _index.classNamesFunction)({
  disableCaching: true
});
...
/** @class */
function (_super) {
  (0, _tslib.__extends)(CalloutContentBase, _super);

  function CalloutContentBase(props) {
    var _this = _super.call(this, props) || this;

    _this._hostElement = /*#__PURE__*/React.createRef();
    _this._calloutElement = /*#__PURE__*/React.createRef();
    ...
    _this._setInitialFocus = function () {
      if (_this.props.setInitialFocus && !_this._didSetInitialFocus && _this.state.positions && _this._calloutElement.current) {
        ...
        _this._async.requestAnimationFrame(function () {
          return (0, _index.focusFirstChild)(_this._calloutElement.current);
    ...
    _this._async = new _index.Async(_this);
  ...
  CalloutContentBase.prototype.shouldComponentUpdate = function (newProps, newState) {
    ...
    return !(0, _index.shallowCompare)(this.props, newProps) || !(0, _index.shallowCompare)(this.state, newState);
  ...
  CalloutContentBase.prototype.render = function () {
    ...
    }, /*#__PURE__*/React.createElement("div", (0, _tslib.__assign)({}, (0, _index.getNativeProps)(this.props, _index.divProperties, ARIA_ROLE_ATTRIBUTES), {
      className: (0, _index.css)(this._classNames.root, positions && positions.targetEdge && ANIMATIONS[positions.targetEdge]),
      style: positions ? positions.elementPosition : OFF_SCREEN_STYLE,
      // Safari and Firefox on Mac OS requires this to back-stop click events so focus remains in the Callout.
      // See https://developer.mozilla.org/en-US/docs/Web/HTML/Element/button#Clicking_and_focus
      tabIndex: -1,
      ref: this._calloutElement
    }), beakVisible && /*#__PURE__*/React.createElement("div", {
      className: this._classNames.beak,
      style: this._getBeakPosition()
    }), beakVisible && /*#__PURE__*/React.createElement("div", {
      className: this._classNames.beakCurtain
    }), /*#__PURE__*/React.createElement(_Popup.Popup, (0, _tslib.__assign)({}, (0, _index.getNativeProps)(this.props, ARIA_ROLE_ATTRIBUTES), {
      ariaLabel: ariaLabel,
  ...
  CalloutContentBase.prototype._dismissOnClickOrScroll = function (ev) {
    ...
    var isEventTargetOutsideCallout = this._hostElement.current && !(0, _index.elementContains)(this._hostElement.current, target); // If mouse is pressed down on callout but moved outside then released, don't dismiss the callout.
    ...
    if (!this._target && isEventTargetOutsideCallout || ev.target !== this._targetWindow && isEventTargetOutsideCallout && (this._target.stopPropagation || !this._target || target !== this._target && !(0, _index.elementContains)(this._target, target))) {
      this.dismiss(ev);
    }
  };
  ...
  CalloutContentBase.prototype._addListeners = function () {
    ...
    this._async.setTimeout(function () {
      _this._disposables.push((0, _index.on)(_this._targetWindow, "scroll", _this._dismissOnScroll, true), (0, _index.on)(_this._targetWindow, "resize", _this._dismissOnResize, true), (0, _index.on)(_this._targetWindow.document.documentElement, "focus", _this._dismissOnLostFocus, true), (0, _index.on)(_this._targetWindow.document.documentElement, "click", _this._dismissOnLostFocus, true));
  ...
  CalloutContentBase.prototype._updatePosition = function () {
    ...
    if (hostElement && calloutElement && (!expectsTarget || this._target)) {
      ...
      currentProps = (0, _index.assign)(currentProps, this.props);
      ...
      var newPositions = this.props.finalHeight ? (0, _positioning.positionCard)(currentProps, hostElement, calloutElement, positions) : (0, _positioning.positionCallout)(currentProps, hostElement, calloutElement, positions); // Set the new position only when the positions are not exists or one of the new callout positions are different.
  ...
  CalloutContentBase.prototype._setTargetWindowAndElement = function (target) {
    ...
    if (target) {
      if (typeof target === "string") {
        var currentDoc = (0, _index.getDocument)(currentElement);
        this._target = currentDoc ? currentDoc.querySelector(target) : null;
        this._targetWindow = (0, _index.getWindow)(currentElement);
      } else if (!!target.stopPropagation) {
        this._targetWindow = (0, _index.getWindow)(target.target);
        this._target = target;
      } else if (!!target.getBoundingClientRect) {
        var targetElement = target;
        this._targetWindow = (0, _index.getWindow)(targetElement);
        this._target = target;
      } else if (target.current !== undefined) {
        this._target = target.current;
        this._targetWindow = (0, _index.getWindow)(this._target); // HTMLImgElements can have x and y values. The check for it being a point must go last.
      } else {
        this._targetWindow = (0, _index.getWindow)(currentElement);
        this._target = target;
      }
  ...
  CalloutContentBase.defaultProps = {
    ...
    gapSpace: 0,
    minPagePadding: 8,
    directionalHint: _common.DirectionalHint.bottomAutoEdge
  };
